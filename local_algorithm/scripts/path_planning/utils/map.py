...
class grid_map:
    ...
    def update_map(self, occupancy_grid, width, height, car_size, origin, orientation,resolution):
    ...
    def set_init_dest_pose(self, init_pose):
        ...
        if (self.car_init_pose != None and self.car_size != None):
            self.dest_pose = (self.car_init_pose[0],self.car_init_pose[1]-2*self.car_size[0],0)
    ...
    def build_wall(self):
        ...
        wall_center = ((self.car_init_pose[0],self.car_init_pose[1]-self.car_size[0],0))
